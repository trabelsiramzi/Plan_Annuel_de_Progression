...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_NUMTEL = "AAAAAAAAAA";
    private static final String UPDATED_NUMTEL = "BBBBBBBBBB";

    private static final Instant DEFAULT_DATEEMBAUCHE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATEEMBAUCHE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .email(DEFAULT_EMAIL)
            .numtel(DEFAULT_NUMTEL)
            .dateembauche(DEFAULT_DATEEMBAUCHE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .email(UPDATED_EMAIL)
            .numtel(UPDATED_NUMTEL)
            .dateembauche(UPDATED_DATEEMBAUCHE);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNumtel()).isEqualTo(DEFAULT_NUMTEL);
        assertThat(testEmployee.getDateembauche()).isEqualTo(DEFAULT_DATEEMBAUCHE);
    }
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].numtel").value(hasItem(DEFAULT_NUMTEL)))
            .andExpect(jsonPath("$.[*].dateembauche").value(hasItem(DEFAULT_DATEEMBAUCHE.toString())));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.numtel").value(DEFAULT_NUMTEL))
            .andExpect(jsonPath("$.dateembauche").value(DEFAULT_DATEEMBAUCHE.toString()));
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNumtel()).isEqualTo(UPDATED_NUMTEL);
        assertThat(testEmployee.getDateembauche()).isEqualTo(UPDATED_DATEEMBAUCHE);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.prenom(UPDATED_PRENOM).email(UPDATED_EMAIL);
