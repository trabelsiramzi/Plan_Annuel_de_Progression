...
public class Affectation implements Serializable {
    ...
    public void setEmployees(Set<Employee> employees) {
        if (this.employees != null) {
            this.employees.forEach(i -> i.removeAffectation(this));
        }
        if (employees != null) {
            employees.forEach(i -> i.addAffectation(this));
        }
    ...
    public Affectation addEmployee(Employee employee) {
        ...
        employee.getAffectations().add(this);
        return this;
    }

    public Affectation removeEmployee(Employee employee) {
        this.employees.remove(employee);
        employee.getAffectations().remove(this);
        return this;
    }
