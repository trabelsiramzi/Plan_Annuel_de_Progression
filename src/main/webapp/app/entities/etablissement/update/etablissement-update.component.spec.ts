...
describe('Etablissement Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call AffectationAdmin query and add missing value', () => {
      ...
      const affectationAdmin: IAffectationAdmin = { id: 23996 };
      etablissement.affectationAdmin = affectationAdmin;

      const affectationAdminCollection: IAffectationAdmin[] = [{ id: 80391 }];
    ...
    it('Should update editForm', () => {
      const etablissement: IEtablissement = { id: 456 };
      const affectationAdmin: IAffectationAdmin = { id: 66449 };
      etablissement.affectationAdmin = affectationAdmin;
