...
describe('Responsable routing resolve service', () => {
  ...
  let resultResponsable: IResponsable | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultResponsable).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IResponsable>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
