...
type EmployeeFormDefaults = Pick<NewEmployee, 'id' | 'dateembauche' | 'affectations' | 'competances'>;
...
type EmployeeFormGroupContent = {
  ...
  affectations: FormControl<EmployeeFormRawValue['affectations']>;
  competances: FormControl<EmployeeFormRawValue['competances']>;
};
...
export class EmployeeFormService {
  createEmployeeFormGroup(employee: EmployeeFormGroupInput = { id: null }): EmployeeFormGroup {
    ...
    return new FormGroup<EmployeeFormGroupContent>({
      ...
      affectations: new FormControl(employeeRawValue.affectations ?? []),
      competances: new FormControl(employeeRawValue.competances ?? []),
    });
  }
  ...
  private convertEmployeeToEmployeeRawValue(
    ...
    return {
      ...
      affectations: employee.affectations ?? [],
      competances: employee.competances ?? [],
    };
  }
}
