...
type AffectationFormDefaults = Pick<NewAffectation, 'id' | 'datedebut' | 'datefin' | 'employees'>;
...
type AffectationFormGroupContent = {
  ...
  projet: FormControl<AffectationFormRawValue['projet']>;
  employees: FormControl<AffectationFormRawValue['employees']>;
};
...
export class AffectationFormService {
  createAffectationFormGroup(affectation: AffectationFormGroupInput = { id: null }): AffectationFormGroup {
    ...
    return new FormGroup<AffectationFormGroupContent>({
      ...
      projet: new FormControl(affectationRawValue.projet),
      employees: new FormControl(affectationRawValue.employees ?? []),
    });
  }
  ...
  private convertAffectationToAffectationRawValue(
    ...
    return {
      ...
      employees: affectation.employees ?? [],
    };
  }
}
